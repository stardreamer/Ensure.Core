...
namespace Ensure.Core.Ensure
{
    ...
    public static partial class Ensure
    {
        ...
        public static class File
        {
            ...
            /// <param name="customMessage">Custom validation ErrorMessage.</param>
            /// <param name="parentType">Type of the class which contains the variable as property.</param>
            /// <exception cref="EnsureException">Thrown when input file is empty</exception> 
            ...
            /// <param name="customMessage">Custom validation ErrorMessage.</param>
            /// <param name="parentType">Type of the class which contains the variable as property.</param>
            /// <exception cref="EnsureException">Thrown when input file is not empty</exception> 
            ...
            /// <param name="customMessage">Custom validation ErrorMessage.</param>
            /// <param name="parentType">Type of the class which contains the variable as property.</param>
            /// <exception cref="EnsureException">Thrown when the input file contains blank or empty lines</exception> 
